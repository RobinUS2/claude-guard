...
var chromeHeaders = [][2]string{
	...
	// Accept-Encoding intentionally omitted: when explicitly set, Go's transport
	// skips automatic gzip decompression. Omitting it lets Go add "gzip" itself
	// and transparently decompress, giving us readable text for LLM inspection.
